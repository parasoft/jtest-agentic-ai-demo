...
# =============================================================================
_RECOGNIZED_KEYS="JTEST_HOME ANALYZED_PROJECT_PATH JTEST_UTA_CONFIGURATION JTEST_COMMIT_FIXES JTEST_STATIC_FILTER_RULE JTEST_SETTINGS JTEST_STATIC_BASE_REPORT JTEST_STATIC_BASE_COVERAGE JTEST_UTA_SCRIPT_DIR JTEST_UTA_RESOURCE JTEST_FIX_ATTEMPTS JTEST_UTA_NO_OF_MAX_FIXES"
